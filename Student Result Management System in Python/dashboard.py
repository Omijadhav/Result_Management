...
class RMS:
    def __init__(self,root):
        ...
        #********* footer *********
        footer = Label(self.root,text="SRMS--Student Result Management System        Contact No :- 8554039117       Made By :- Sakshi, Sakshi, & Neha",font = ("goudy old style",13),bg="#262626",fg="white").pack(side=BOTTOM,fill=X) 
        self.update_details()
